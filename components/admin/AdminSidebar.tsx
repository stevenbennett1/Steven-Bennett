...
export default function AdminSidebar({ pendingComments = 0 }: { pendingComments?: number }) {
  ...
  const links = [
    { href: "/blog/admin", label: "Dashboard", icon: LayoutDashboard, exact: true },
    { href: "/blog/admin/posts/new", label: "New post", icon: PlusCircle, exact: true },
    { href: "/blog/admin/categories", label: "Categories", icon: Tags, exact: true },
    { href: "/blog/admin/resources", label: "Resources", icon: BookMarked, exact: true },
    { href: "/blog/admin/comments", label: "Comments", icon: MessageCircle, exact: true, badge: pendingComments },
    { href: "/blog/admin/subscribers", label: "Subscribers", icon: Mail, exact: true },
  ];
